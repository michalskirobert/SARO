...
function sendMail() {
  ...
  var successMsg =
    "Your message has been sent. <br /> Thank you. <br /> You also have received confirmation via email.";
  var failMsg = "Mail coudln't be sent. <br /> Please try again.";
  var failCaptcha = "Check captcha :) unless you are a robot 🤖";
  var captchaIssue =
    "It's just captcha issue... <br> please contact us by sending report";
