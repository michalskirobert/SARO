...
<a href="https://saro.website/learnmore">privacy policy</a> and <a href="https://saro.website/learnmore">cookie policy</a>.`;
  ...
  cookiesCont.innerHTML = `当サイトは、お客様により良いサービスを提供するため、Cookieを使用しています。これには、ユーザーに合わせたコンテンツと広告が含まれます。 詳細については、<a href="https://saro.website/learnmore#japanese" target="_blank"> ここをクリック してください</a> 当サイトを引き続きご利用いただく際は、Cookieの使用、改訂されたプライバシーポリシーおよび利用規約に同意いただいたものとみなします。Cookieについて詳しくは<a href="" target="_blank">こちら</a>`;
  newBtn.innerHTML = "I understood";
}
}
