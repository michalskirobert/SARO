...
function report() {
  ...
  var languageReport = document.getElementsByTagName("html");

  for (var i = 0; i < language.length; i++) {
    if (languageReport[i].lang === "en") {
      var codeBlock = `
    ...
    <input name="language" id="language" value="${languageReport[i].lang}" style="display: none;">
    ...
    } else if (languageReport[i].lang === "ja") {
      var codeBlock = `
    <div class="report__base" id="myReport">
    <span id="close" onclick="showOld()">&times;</span>
    <div class="report__content" id="report01">
    ...
    } else if (languageReport[i].lang === "zh") {
      var codeBlock = `
    <div class="report__base" id="myReport">
    <span id="close" onclick="showOld()">&times;</span>
    <div class="report__content" id="report01">
